  ...
  return (
    <div className="descr">
      ...
      <div>
        ...
        кошик, змінювати кількість товарів, ставити лайк, також йде підрахунок
        суми товарів, зі сторінки кошика товари можна видаляти, змінювати
        кількість, ставити/прибирати лайк , також можна перейти на сторінку реєстрації та зареєструватись
      </div>
      <div>
        <a
