  ...
  return ( 
    <div className="descr">
        <div>
          ...
          переходити як на всі категорії статей, так і на кожну статтю окремо,
        ...
        <div>
          ...
          зроблений на React, в якому можна з головної сторінки додавати товари
          в кошик, змінювати кількість товарів, ставити лайк, також йде
        ...
        <div>
          ...
          зроблено за макетом терміналу самообслуговування ПриватБанку, при
          кліку на стрілку можна потрапити на другий екран
        </div>
    </div>
  );
};
